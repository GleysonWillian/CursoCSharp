...
class Aula23
{
    static void Main()
    {
        ...
        //public void CopyTo(Ar_destino, a_partir_desta-pos):
        ...
        //publi int GetUpperBound(dimensão):
        ...
        Console.WriteLine("Índice de último valor 33: {0}", indice2);
        Console.WriteLine("-----------------------------------------------------");
        ...
        //public void SetValue(objetc valor, long pos):
